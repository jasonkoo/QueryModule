...
import com.lenovo.push.data.serving.dao.BaseDao;
import com.lenovo.push.data.serving.mapper.BaseMapper;
import com.lenovo.push.data.serving.util.Page;
...
public class BaseDaoImpl<T, E> extends SqlSessionDaoSupport implements BaseDao<T, E>
{
	...
	@Autowired
	public void setSqlSessionTemplate(@Qualifier("mysqlSqlSessionTemplate") SqlSessionTemplate sqlSessionTemplate) {
	...
	public E getMapper()
	{
		return getSqlSession().getConfiguration().getMapper(mapperClass, getSqlSession());
	}
